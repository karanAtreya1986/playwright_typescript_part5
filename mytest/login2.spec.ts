// import {test, expect, type Browser, type Page,type Locator} from 'playwright'
//here only playwright wont work.
//Module '"playwright"' has no exported member 'test'.ts(2305)
// Module '"playwright"' has no exported member 'expect'.ts(2305)
