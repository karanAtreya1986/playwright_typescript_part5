...
test('chaining locator test', async()=>{
   ...
   const page:Page = await browser.newPage();
    ...
    //use placeholder and check if the aria is able to identify.
    //it doesnt identify the element.
     await page.locator('form#Form_getForm').getByRole('textbox', { name: 'Your Full Name*' }).fill('karan');
